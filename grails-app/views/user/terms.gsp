...
<head>
    ...
    <title>Terminos y condiciones DiscMaster</title>
</head>
...
<div class="row">
    <div class="twelve columns text-center">
        ...
        <p>Las presentes condiciones generales de uso de la página web, regulan los términos y condiciones de acceso y uso de www.discmaster.herokuapp.com, propiedad de Danilo moncaleano, Adriana Lozano, Sergio Cabezas, Elkin Cruz y Daniel Uchamocha, con domicilio en Bogota y con Código de Identificación Fiscal número [pendiente], en adelante, «la Empresa», que el usuario del Portal deberá de leer y aceptar para usar todos los servicios e información que se facilitan desde el portal. El mero acceso y/o utilización del portal, de todos o parte de sus contenidos y/o servicios significa la plena aceptación de las presentes condiciones generales de uso.</p>
        ...
        <h2>5. Responsabilidad del portal</h2>
        ...
        <h2>7. Legislación aplicable, jurisdicción competente y notificaciones </h2>

		...
		<article>
			<div class="row">
				...
				<div class="large-6 columns">
					...
					<p>
						<span><i class="fi-torso"> By Daniel &nbsp;&nbsp;</i></span>
						<span><i class="fi-calendar"> 19/03/2016 &nbsp;&nbsp;</i></span>
			...
			<div class="row">
				...
				<div class="large-6 columns">
					...
					<p>
						<span><i class="fi-torso"> By Sergio &nbsp;&nbsp;</i></span>
						<span><i class="fi-calendar"> 14/03/16 &nbsp;&nbsp;</i></span>
						<span><i class="fi-comments"> 10 comments</i></span>
					</p>
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae impedit beatae, ipsum delectus aperiam nesciunt magni facilis ullam.</p>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="large-6 columns">
					...
					<p>
						<span><i class="fi-torso"> By Daniel &nbsp;&nbsp;</i></span>
						<span><i class="fi-calendar"> 14/02/16 &nbsp;&nbsp;</i></span>
						<span><i class="fi-comments"> 17 comments</i></span>
					</p>
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae impedit beatae, ipsum delectus aperiam nesciunt magni facilis ullam.</p>
				</div>
			</div>

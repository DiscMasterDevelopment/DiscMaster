...
<head>
	...
	<style>
	@font-face{
		font-family: annapolis3d;
		font-style: normal;
		font-weight: normal;
		src: url(annapolis3d.ttf);
	}

	@font-face{
		font-family: flamaespina2;
		font-style: normal;
		font-weight: normal;
		src: url(Flama_Espina_2.TTF);
	}
...
<header>
	<div class="top-bar", style="background-color:red">
		<div class="top-bar-right" style="background-color:red">
			<ul class="menu">
				<li style="background-color:red"><a href="#" style="color:white">Iniciar Sesión</a></li>
				...
				<li style="background-color:red"><a href="#" style="color:white"><img src="img/carrito-de-compras.png" alt="kart" style="width:30px;height:30px;"></a></li>
			</ul>
		</div>
...
<div class="row">
	<div class="medium-7 columns">
		<p><img src="../../web-app/images/Soulfly_Bogota.jpg" alt="main article image"></p>
	</div>
	<div class="medium-5 columns">
		<p><img src="img/amorphis-latinoamerica-2016.jpg" alt="article promo image"></p>
		<p><img src="img/riotttt.jpg" alt="article promo image"></p>
		<p><img src="img/CandlemassColombia.png" alt="article promo image"></p>
	</div>
</div>
<hr>
<div class="row column">
		...
		<article>
			<div class="row">
				<div class="large-6 columns">
					<p><img src="img/RockAl.jpg" alt="image for article" alt="article preview image"></p>
				</div>
				<div class="large-6 columns">
			...
			<div class="row">
				<div class="large-6 columns">
					<p><img src="img/Usmetal-Festival-Logo-2.png" alt="image for article" alt="article preview image"></p>
				</div>
				<div class="large-6 columns">
			...
			<div class="row">
				<div class="large-6 columns">
					<p><img src="img/Metal_Millenium_2016.png" alt="image for article" alt="article preview image"></p>
				</div>
				<div class="large-6 columns">
